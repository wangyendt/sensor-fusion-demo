...
public class EarbudsCaliOnce extends OrientationProvider {
    ...
    public EarbudsCaliOnce(SensorManager sensorManager,
                           float gain,
                           float sampleFreq) {
        super(sensorManager);
        this.gain = gain;
...
//            currentOrientationQuaternion.setXYZW(qX, qY, qZ, -qW); //-q for cube rotation inversion
            currentOrientationQuaternion.setXYZW(-qZ_, -qX, -qY_, -qW_); //-q for cube rotation inversion
        }
    }
